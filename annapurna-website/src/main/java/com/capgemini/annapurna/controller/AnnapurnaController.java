...
//	@RequestMapping("/GetAccountFormProfileId")
//	public String getAccountFormIdForm(@RequestParam("profileId") int profileId,Model model) {
//		System.out.println("Inside the gettingAccountFromId");
//		 profile=restTemplate.getForObject("http://localhost:3251/profiless/"+profileId,Profile.class);
//		//0 System.out.println(profile.getAddress().getStreetName());
//		model.addAttribute("profile", profile);
//		return "showingdetailsform";
	//}
